...
<div class="main-wrapper">
    ...
    <div class="col-md-12" style="text-align: center">
        <h1 style="padding-top: 40px;padding-bottom: 15px;color: darkgreen"><strong>Welcome to SimTier v0.2 (beta) !!!</strong></h1>
        <h4 style="color: darkgreen;padding-bottom: 70px">SimTier is the PHP framework for developing web sites. It is in beta version now.
            <br>
            <br>
