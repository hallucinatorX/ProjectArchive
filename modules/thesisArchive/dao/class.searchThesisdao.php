...
Class SearchThesisDao
{
    ...
    public function getSearchedThesis(){
        ...
        if (isset($_POST['member_id'])&&!empty($_POST['member_id'])&&$_POST['teacher_id']&&!empty($_POST['teacher_id'])){
            $SQL="SELECT DISTINCT tms_thesis.id,tms_thesis.thumbnail,tms_thesis.title,tms_thesis.description,tms_thesis.link,
