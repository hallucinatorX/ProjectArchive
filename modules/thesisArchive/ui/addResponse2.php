...
// Check connection
    ...
    AND tbl_user.Email NOT IN (SELECT tms_supervisor_thesis.supervisor_id FROM tms_supervisor_thesis WHERE 
    tms_supervisor_thesis.thesis_id='".$PId."') AND tbl_user.Email LIKE '%$Key%'";
